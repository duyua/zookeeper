    ...
    <div class="access">
        ...
        <div class="list_right">
            ...
            <ul id="list" class="main_list">
                ...
                <li>
                    <div class="chip">
                        <a data-sku="681DJ1920000C27" target="_blank" href="/p/681DJ1920000C27.jsp">
                            <img alt="百褶短袖雪纺连衣裙" src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681DJ1920000C27" data-rollover="sku,list-1">
                            <span class="chip_name">
									百褶短袖雪纺连衣裙
								</span>
                        </a>
                ...
                <li>
                    <div class="chip">
                        <a data-sku="681DJ1920000G24" target="_blank" href="/p/681DJ1920000G24.jsp">
                            <img alt="百褶短袖雪纺连衣裙" src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681DJ1920000G24" data-rollover="sku,list-1">
                            <span class="chip_name">
									百褶短袖雪纺连衣裙
								</span>
                        </a>
