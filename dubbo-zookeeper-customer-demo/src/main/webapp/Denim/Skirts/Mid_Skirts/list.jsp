...
<head>
    ...
    <title>Miss Sixty 中国官网 - 中裙</title>
    ...
    <div class="access">
        ...
        <div class="aside_left">
            ...
            <dl class="catalog">
                ...
                <dd class="active">
                    ...
                    <a href="/Denim/Skirts/Mid_Skirts/list.jsp"  class="select">中裙</a>
        ...
        <div class="list_right">
            ...
            <ul id="list" class="main_list">
                ...
                <li>
                    <div class="chip">
                        <a data-sku="681KJ4410000G24" target="_blank" href="/p/681KJ4410000G24.shtml">
                            <img alt="绣花剪边牛仔半身中裙" src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681KJ4410000G24" data-rollover="sku,list-1">
                            <span class="chip_name">
									绣花剪边牛仔半身中裙
								</span>
                        </a>
