...
<head>
    ...
    <title>Miss Sixty 中国官网 - 连体裤</title>
    ...
    <div class="access">
        ...
        <div class="aside_left">
            ...
            <dl class="catalog">
                ...
                <dt class="active2 nobg"><a href="/Denim/Jumpsuits/list.jsp">连体裤</a></dt>
            </dl>
        ...
        <div class="list_right">
            ...
            <ul id="list" class="main_list">
                <li>
                    <div class="chip">
                        <a data-sku="683JJ2450000F25" target="_blank" href="/p/683JJ2450000F25.shtml">
                ...
                <li>
                    <div class="chip">
                        <a data-sku="682JJ3230000F25" target="_blank" href="/p/682JJ3230000F25.shtml">
                            <img alt="纯棉牛仔连体裤背带裤" src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="682JJ3230000F25" data-rollover="sku,list-1">
                            <span class="chip_name">
									纯棉牛仔连体裤背带裤
								</span>
                        </a>
                ...
                <li>
                    <div class="chip">
                        <a data-sku="682JJ1570000F25" target="_blank" href="/p/682JJ1570000F25.shtml">
                            <img alt="连体长裤牛仔背带裤" src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="682JJ1570000F25" data-rollover="sku,list-1">
                            <span class="chip_name">
									连体长裤牛仔背带裤
								</span>
                        </a>
                ...
                <li>
                    <div class="chip">
                        <a data-sku="682JJ1590000F25" target="_blank" href="/p/682JJ1590000F25.shtml">
                            <img alt="绣花长袖牛仔连体短裤" src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="682JJ1590000F25" data-rollover="sku,list-1">
                            <span class="chip_name">
									绣花长袖牛仔连体短裤
								</span>
                        </a>
                ...
                <li>
                    <div class="chip">
                        <a data-sku="682JJ3910000F25" target="_blank" href="/p/682JJ3910000F25.shtml">
                            <img alt="露背阔腿牛仔连体长裤" src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="682JJ3910000F25" data-rollover="sku,list-1">
                            <span class="chip_name">
									露背阔腿牛仔连体长裤
								</span>
                        </a>
