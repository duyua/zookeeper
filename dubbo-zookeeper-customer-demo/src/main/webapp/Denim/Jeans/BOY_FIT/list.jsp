...
<head>
    ...
    <title>Miss Sixty 中国官网 - BOY FIT 男友风</title>
    ...
    <div class="access">
        ...
        <div class="aside_left">
            ...
            <dl class="catalog">
                ...
                <dd class="active">
                    ...
                    <a href="/Denim/Jeans/BOY_FIT/list.jsp"  class="select">BOY FIT 男友风</a>
        ...
        <div class="list_right">
            ...
            <ul id="list" class="main_list">
                ...
                <li>
                    <div class="chip">
                        <a data-sku="681JJ2390000F25" target="_blank" href="/p/681JJ2390000F25.shtml">
                            <img alt="BOY FIT<br />高腰拼接直筒牛仔长裤" src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681JJ2390000F25" data-rollover="sku,list-1">
                            <span class="chip_name">
									BOY FIT<br />高腰拼接直筒牛仔长裤
								</span>
                        </a>
