...
<head>
    ...
    <title>Miss Sixty 中国官网 - EVERYDAY</title>
    ...
    <div class="access">
        ...
        <div class="aside_left">
            ...
            <dl class="catalog">
                ...
                <dd class="active">
                    <a href="/Denim/Jeans/EVERYDAY/list.jsp"  class="select">EVERYDAY</a>
        ...
        <div class="list_right">
            ...
            <ul id="list" class="main_list">
                ...
                <li>
                    <div class="chip">
                        <a data-sku="682JJ3250000F25" target="_blank" href="/p/682JJ3250000F25.shtml">
                            <img alt="EVERYDAY<br />纯棉高腰直筒牛仔长裤" src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="682JJ3250000F25" data-rollover="sku,list-1">
                            <span class="chip_name">
									EVERYDAY<br />纯棉高腰直筒牛仔长裤
								</span>
                        </a>
