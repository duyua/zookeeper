        ...
        <form id="jibenxinzengid">
            <table cellpadding="0" border="1" >
                <tr>
                    ...
                    <td>
                        <input id="cc" class="easyui-combobox" name="typeid"  data-options="valueField:'classid',textField:'classname',url:'<%=request.getContextPath()%>/basicController/typelist.do'" />
                    </td>
                    <td>
                        商品名称：
                    </td>
