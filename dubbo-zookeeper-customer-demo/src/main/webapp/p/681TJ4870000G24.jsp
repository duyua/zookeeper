...
<head>
    ...
    <meta name="description" content="印花连帽长袖套头卫衣,681TJ4870000G24,欢迎访问MissSixty官方中文网站。源自意大利的女性牛仔品牌，始于1991，一直为性感时尚的女性带来极具个性与创造力的牛仔设计。点击访问，轻松享受便捷的购物体验及获取最新牛仔潮流资讯。" />
    ...
    <script>
        ...
        proInfo.imgUrl = 'http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4870000G24/681TJ4870000G24_s_2.jpg';
                ...
                <div class="detail_center">
                    ...
                    <div class="pro_img">
                        <div id="productImgTab" class="pro_smallpic_box">
                            ...
                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4870000G24,s,1" onclick="te$.ui.zoom.setSrc('681TJ4870000G24','1', 's')" alt="印花连帽长袖套头卫衣"  class="active"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4870000G24/681TJ4870000G24_s_1.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4870000G24,s,2" onclick="te$.ui.zoom.setSrc('681TJ4870000G24','2', 's')" alt="印花连帽长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4870000G24/681TJ4870000G24_s_2.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4870000G24,s,3" onclick="te$.ui.zoom.setSrc('681TJ4870000G24','3', 's')" alt="印花连帽长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4870000G24/681TJ4870000G24_s_3.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4870000G24,s,4" onclick="te$.ui.zoom.setSrc('681TJ4870000G24','4', 's')" alt="印花连帽长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4870000G24/681TJ4870000G24_s_4.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4870000G24,s,5" onclick="te$.ui.zoom.setSrc('681TJ4870000G24','5', 's')" alt="印花连帽长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4870000G24/681TJ4870000G24_s_5.jpg -->
                        </div>
                        ...
                        <div id="productImgShow" class="pro_bigpic_box">
                            <div id="jqzoom" class="product_img_show">
                                ...
                                <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4870000G24,m,1" alt="印花连帽长袖套头卫衣" jqimg="">
                            </div>
                            <script>
                                (function(){
                                    t$('jqzoom').getElementsByTagName('img')[0].setAttribute('jqimg', te$.skuToImgUrl('681TJ4870000G24', 'b', 1));
                                })();
                            </script>
                    ...
                    <div class="pro_info">
                        ...
                        <div id="proSellOut" class="pro_sell_out">
                            <!--正常-->
                            <a id="btnSellOut" target="_blank" href="/applets/ProductArrivalNoticeAdd.do?productItemId=681TJ4870000G24" class="btn_sell_out">到货通知</a>
                            <script>
                                (function(){
                                    var s = t$('btnSellOut');
                            ...
                            <dd class="detail_content_box active">
                                <div class="detail_content_txt" id="productInfo"><!-- id="detailContent1" -->
                                    ...
                                    <dl>
                                        <dt><span>-</span> 设计</dt>
                                        <dd>
                                            短款合体剪裁活力减龄，同时视觉美化身材比例；微垫肩效果，带来笔挺廓形感，更显前卫个性气场；休闲连帽设计，融合字母Slogan和印花图案，表达年轻人随性趣味的时尚态度。
                                        </dd>
                                    </dl>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            ● 合体剪裁<br>● 中等重量面料，罗纹带弹力<br>● 模特身高 176 厘米，所穿尺码 s
                                        </dd>
                                        <script>
                                            (function(){
                                                var size = [["尺码","衣长","肩宽","胸围","袖长","腰围","适合身高"],["XS","48.0","44.0","101.0","58.0","-","154/165"],["S","49.0","45.0","104.0","59.0","-","160/171"],["M","50.0","46.0","107.0","60.0","-","166/177"],["L","51.0","47.0","111.0","60.0","-","172/181"]];
                                                if (size) {
            ...
            <div class="roll_box_2013">
                <div id="roll2013">
                    <ul class="main_list">
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681JJ4440000F25.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681JJ4440000F25,n,5">
                                </a>
                            </div>
                        </li>
                    </ul>
