...
<head>
    ...
    <title>印花宽松长袖套头卫衣 - Miss Sixty 中国官网</title>

    <meta name="description" content="印花宽松长袖套头卫衣,681TJ1380000A06,欢迎访问MissSixty官方中文网站。源自意大利的女性牛仔品牌，始于1991，一直为性感时尚的女性带来极具个性与创造力的牛仔设计。点击访问，轻松享受便捷的购物体验及获取最新牛仔潮流资讯。" />
    <meta name="keywords" content="MISS SIXTY | 意大利女性时尚牛仔品牌,印花宽松长袖套头卫衣,miss sixty官网,miss sixty,misssixty,miss sixty官方购物网,Miss Sixty中文官网,Miss Sixty中国,Miss Sixty亚洲,Miss Sixty购物,Miss Sixty正品,潮流牛仔,M60,丹宁,女性牛仔,品牌女装,服装商城,意大利女装,意大利牛仔" />
    ...
    <script>
        var	proInfo = {
            storeId : '23',
            cId : '137823',
            ecsId : '#1909#2678#2679#2680#2681#5171#1239#1246#1243#',
            buyAble : 1, //1,
            sku : '681TJ1380000A06',
            proName : '印花宽松长袖套头卫衣',
            brandInfo : 'misssixty',
        ...
        proInfo.imgUrl = 'http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ1380000A06/681TJ1380000A06_s_2.jpg';
...
<div id="proFrame">
                ...
                <div class="detail_center">
                    ...
                    <div class="pro_img">
                        <div id="productImgTab" class="pro_smallpic_box">
                            ...
                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ1380000A06,s,1" onclick="te$.ui.zoom.setSrc('681TJ1380000A06','1', 's')" alt="印花宽松长袖套头卫衣"  class="active"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ1380000A06/681TJ1380000A06_s_1.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ1380000A06,s,2" onclick="te$.ui.zoom.setSrc('681TJ1380000A06','2', 's')" alt="印花宽松长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ1380000A06/681TJ1380000A06_s_2.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ1380000A06,s,3" onclick="te$.ui.zoom.setSrc('681TJ1380000A06','3', 's')" alt="印花宽松长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ1380000A06/681TJ1380000A06_s_3.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ1380000A06,s,4" onclick="te$.ui.zoom.setSrc('681TJ1380000A06','4', 's')" alt="印花宽松长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ1380000A06/681TJ1380000A06_s_4.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ1380000A06,s,5" onclick="te$.ui.zoom.setSrc('681TJ1380000A06','5', 's')" alt="印花宽松长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ1380000A06/681TJ1380000A06_s_5.jpg -->
                        </div>
                        ...
                        <div id="productImgShow" class="pro_bigpic_box">
                            <div id="jqzoom" class="product_img_show">
                                ...
                                <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ1380000A06,m,1" alt="印花宽松长袖套头卫衣" jqimg="">
                            </div>
                            <script>
                                (function(){
                                    t$('jqzoom').getElementsByTagName('img')[0].setAttribute('jqimg', te$.skuToImgUrl('681TJ1380000A06', 'b', 1));
                                })();
                            </script>
                    ...
                    <div class="pro_info">
                        ...
                        <div id="proSellOut" class="pro_sell_out">
                            <!--正常-->
                            <a id="btnSellOut" target="_blank" href="/applets/ProductArrivalNoticeAdd.do?productItemId=681TJ1380000A06" class="btn_sell_out">到货通知</a>
                            <script>
                                (function(){
                                    var s = t$('btnSellOut');
                        ...
                        <dl id="proColor" class="pro_option pro_color" style="display:none;">
                            <!-- <dt>颜色:</dt> -->
                            <dd>
                                <a href="/p/681TJ1380000C09.jsp" target="_blank"><img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ1380000C09,s,5" title="紫红"></a>
                            </dd>
                        </dl>
                            ...
                            <dd class="detail_content_box active">
                                <div class="detail_content_txt" id="productInfo"><!-- id="detailContent1" -->
                                    ...
                                    <dl>
                                        <dt><span>-</span> 设计</dt>
                                        <dd>
                                            选用柔软透气纯棉面料打造，穿着舒适自在；简约流畅宽松廓形，巧妙包容和修饰身形，百搭实穿；加入卡通图案和字母印花，增添个性抢镜亮点，赋予单品以时尚趣味和休闲活力感。
                                        </dd>
                                    </dl>
                                    ...
                                    <dl>
                                        ...
                                        <script>
                                            (function(){
                                                var size = [["尺码","衣长","肩宽","胸围","袖长","腰围","适合身高"],["XS","59.0","53.0","101.0","54.0","-","154/159"],["S","60.0","54.0","104.0","55.0","-","160/165"],["M","61.0","55.0","107.0","56.0","-","166/171"],["L","62.0","55.0","107.0","56.0","-","172/175"]];
                                                if (size) {
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ● 面料:棉100%<br>● 罗纹:棉75.2% 聚酯纤维22.5% 氨纶2.3%
                                        </dd>
                                    </dl>
            ...
            <div class="roll_box_2013">
                <div id="roll2013">
                    <ul class="main_list">
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681JJ3640000F25.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681JJ3640000F25,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681PJ1130000C11.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681PJ1130000C11,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681JJ3760000G24.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681JJ3760000G24,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
    ...
    <script>(function(){if (4 > 0) t$('bundleList').style.display = 'block';})();</script>
