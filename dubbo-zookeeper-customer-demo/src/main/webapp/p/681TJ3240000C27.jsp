...
<head>
    ...
    <title>天使之翼印花套头卫衣 - Miss Sixty 中国官网</title>

    <meta name="description" content="天使之翼印花套头卫衣,681TJ3240000C27,欢迎访问MissSixty官方中文网站。源自意大利的女性牛仔品牌，始于1991，一直为性感时尚的女性带来极具个性与创造力的牛仔设计。点击访问，轻松享受便捷的购物体验及获取最新牛仔潮流资讯。" />
    <meta name="keywords" content="MISS SIXTY | 意大利女性时尚牛仔品牌,天使之翼印花套头卫衣,miss sixty官网,miss sixty,misssixty,miss sixty官方购物网,Miss Sixty中文官网,Miss Sixty中国,Miss Sixty亚洲,Miss Sixty购物,Miss Sixty正品,潮流牛仔,M60,丹宁,女性牛仔,品牌女装,服装商城,意大利女装,意大利牛仔" />
    ...
    <script>
        var	proInfo = {
            storeId : '23',
            cId : '137828',
            ecsId : '#2678#2679#2680#2681#4141#2132#1239#1246#1243#',
            buyAble : 1, //1,
            sku : '681TJ3240000C27',
            proName : '天使之翼印花套头卫衣',
            brandInfo : 'misssixty',
        ...
        proInfo.imgUrl = 'http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ3240000C27/681TJ3240000C27_s_2.jpg';
                ...
                <div class="detail_center">
                    ...
                    <div class="pro_img">
                        <div id="productImgTab" class="pro_smallpic_box">
                            ...
                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ3240000C27,s,1" onclick="te$.ui.zoom.setSrc('681TJ3240000C27','1', 's')" alt="天使之翼印花套头卫衣"  class="active"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ3240000C27/681TJ3240000C27_s_1.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ3240000C27,s,2" onclick="te$.ui.zoom.setSrc('681TJ3240000C27','2', 's')" alt="天使之翼印花套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ3240000C27/681TJ3240000C27_s_2.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ3240000C27,s,3" onclick="te$.ui.zoom.setSrc('681TJ3240000C27','3', 's')" alt="天使之翼印花套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ3240000C27/681TJ3240000C27_s_3.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ3240000C27,s,4" onclick="te$.ui.zoom.setSrc('681TJ3240000C27','4', 's')" alt="天使之翼印花套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ3240000C27/681TJ3240000C27_s_4.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ3240000C27,s,5" onclick="te$.ui.zoom.setSrc('681TJ3240000C27','5', 's')" alt="天使之翼印花套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ3240000C27/681TJ3240000C27_s_5.jpg -->
                        </div>
                        ...
                        <div id="productImgShow" class="pro_bigpic_box">
                            <div id="jqzoom" class="product_img_show">
                                ...
                                <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ3240000C27,m,1" alt="天使之翼印花套头卫衣" jqimg="">
                            </div>
                            <script>
                                (function(){
                                    t$('jqzoom').getElementsByTagName('img')[0].setAttribute('jqimg', te$.skuToImgUrl('681TJ3240000C27', 'b', 1));
                                })();
                            </script>
                    ...
                    <div class="pro_info">
                        ...
                        <div id="proSellOut" class="pro_sell_out">
                            <!--正常-->
                            <a id="btnSellOut" target="_blank" href="/applets/ProductArrivalNoticeAdd.do?productItemId=681TJ3240000C27" class="btn_sell_out">到货通知</a>
                            <script>
                                (function(){
                                    var s = t$('btnSellOut');
                        ...
                        <dl id="proColor" class="pro_option pro_color" style="display:none;">
                            <!-- <dt>颜色:</dt> -->
                            <dd>
                                <a href="/p/681TJ3240000A28.jsp" target="_blank"><img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ3240000A28,s,5" title="白色"></a>
                                <a href="/p/681TJ3240000G24.jsp" target="_blank"><img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ3240000G24,s,5" title="黑色"></a>
                            </dd>
                        </dl>
                            ...
                            <dd class="detail_content_box active">
                                <div class="detail_content_txt" id="productInfo"><!-- id="detailContent1" -->
                                    ...
                                    <dl>
                                        <dt><span>-</span> 设计</dt>
                                        <dd>
                                            宽松流畅廓形，巧妙包容和修饰身材，百搭实穿；巧妙将小一字领和连帽设计结合，个性休闲中流露性感韵味；运用精湛的植绒印花工艺，以简洁的涂鸦线条，勾画出个性活力的天使之翼图案，融合字母Slogan，传递精致街头感和年轻时尚趣味。
                                        </dd>
                                    </dl>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            ● 宽松剪裁<br>● 中等重量面料，无弹力<br>● 模特身高 176 厘米，所穿尺码 s
                                        </dd>
                                        <script>
                                            (function(){
                                                var size = [["尺码","衣长","肩宽","胸围","袖长","腰围","适合身高"],["XS","57.0","66.0","121.0","51.0","-","154/159"],["S","59.0","67.0","124.0","52.0","-","160/165"],["M","60.0","69.0","127.0","53.0","-","166/171"],["L","61.0","69.0","127.0","53.0","-","172/175"]];
                                                if (size) {
                                    ...
                                    <dl>
                                        ...
                                        <dd>30℃以下网袋机洗；不可漂白；悬挂晾干；低温熨烫；不可干洗；不可曝晒；反面洗涤；请勿浸泡；装饰工艺部位不可揉搓；不可熨烫；请与同类颜色衣物洗涤</dd>
                                    </dl>
            ...
            <div class="roll_box_2013">
                <div id="roll2013">
                    <ul class="main_list">
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681KJ3300000B26.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681KJ3300000B26,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681KJ7150000F25.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681KJ7150000F25,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681KJ7210000F58.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681KJ7210000F58,n,5">
                                </a>
                            </div>
                        </li>
                    </ul>
