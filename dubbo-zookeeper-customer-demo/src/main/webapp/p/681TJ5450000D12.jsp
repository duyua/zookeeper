...
<head>
    ...
    <title>印花连帽长袖套头卫衣 - Miss Sixty 中国官网</title>

    <meta name="description" content="印花连帽长袖套头卫衣,681TJ5450000D12,欢迎访问MissSixty官方中文网站。源自意大利的女性牛仔品牌，始于1991，一直为性感时尚的女性带来极具个性与创造力的牛仔设计。点击访问，轻松享受便捷的购物体验及获取最新牛仔潮流资讯。" />
    <meta name="keywords" content="MISS SIXTY | 意大利女性时尚牛仔品牌,印花连帽长袖套头卫衣,miss sixty官网,miss sixty,misssixty,miss sixty官方购物网,Miss Sixty中文官网,Miss Sixty中国,Miss Sixty亚洲,Miss Sixty购物,Miss Sixty正品,潮流牛仔,M60,丹宁,女性牛仔,品牌女装,服装商城,意大利女装,意大利牛仔" />
    ...
    <script>
        ...
        proInfo.imgUrl = 'http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ5450000D12/681TJ5450000D12_s_2.jpg';
                ...
                <div class="detail_center">
                    ...
                    <div class="pro_img">
                        <div id="productImgTab" class="pro_smallpic_box">
                            ...
                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ5450000D12,s,1" onclick="te$.ui.zoom.setSrc('681TJ5450000D12','1', 's')" alt="印花连帽长袖套头卫衣"  class="active"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ5450000D12/681TJ5450000D12_s_1.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ5450000D12,s,2" onclick="te$.ui.zoom.setSrc('681TJ5450000D12','2', 's')" alt="印花连帽长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ5450000D12/681TJ5450000D12_s_2.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ5450000D12,s,3" onclick="te$.ui.zoom.setSrc('681TJ5450000D12','3', 's')" alt="印花连帽长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ5450000D12/681TJ5450000D12_s_3.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ5450000D12,s,4" onclick="te$.ui.zoom.setSrc('681TJ5450000D12','4', 's')" alt="印花连帽长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ5450000D12/681TJ5450000D12_s_4.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ5450000D12,s,5" onclick="te$.ui.zoom.setSrc('681TJ5450000D12','5', 's')" alt="印花连帽长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ5450000D12/681TJ5450000D12_s_5.jpg -->
                        </div>
                        ...
                        <div id="productImgShow" class="pro_bigpic_box">
                            <div id="jqzoom" class="product_img_show">
                                ...
                                <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ5450000D12,m,1" alt="印花连帽长袖套头卫衣" jqimg="">
                            </div>
                            <script>
                                (function(){
                                    t$('jqzoom').getElementsByTagName('img')[0].setAttribute('jqimg', te$.skuToImgUrl('681TJ5450000D12', 'b', 1));
                                })();
                            </script>
                    ...
                    <div class="pro_info">
                        ...
                        <div id="proSellOut" class="pro_sell_out">
                            <!--正常-->
                            <a id="btnSellOut" target="_blank" href="/applets/ProductArrivalNoticeAdd.do?productItemId=681TJ5450000D12" class="btn_sell_out">到货通知</a>
                            <script>
                                (function(){
                                    var s = t$('btnSellOut');
                        ...
                        <dl id="proColor" class="pro_option pro_color" style="display:none;">
                            <!-- <dt>颜色:</dt> -->
                            <dd>
                                <a href="/p/681TJ5450000G24.jsp" target="_blank"><img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ5450000G24,s,5" title="黑色"></a>
                            </dd>
                        </dl>
                            ...
                            <dd class="detail_content_box active">
                                <div class="detail_content_txt" id="productInfo"><!-- id="detailContent1" -->
                                    ...
                                    <dl>
                                        <dt><span>-</span> 设计</dt>
                                        <dd>
                                            简约流畅剪裁，以其潮流大廓形巧妙包容和修饰身形，融合慵懒的落肩袖设计，流露休闲随性之感；加入女权主义标识的Slogan印花，展现年轻人独立自由的态度；柔软纯棉面料，带来舒适自在穿着感。
                                        </dd>
                                    </dl>
                                    ...
                                    <dl>
                                        ...
                                        <script>
                                            (function(){
                                                var size = [["尺码","衣长","肩宽","胸围","袖长","腰围","适合身高"],["XS","76.0","-","127.0","49.0","-","154/167"],["S","77.0","-","130.0","50.0","-","160/173"],["M","79.0","-","133.0","51.0","-","166/179"],["L","80.0","-","133.0","51.0","-","172/183"]];
                                                if (size) {
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ● 面料:棉100%<br>● 帽里料:棉100%<br>● 罗纹:棉70.9% 聚酯纤维26.1% 氨纶3.0%
                                        </dd>
                                    </dl>
            ...
            <div class="roll_box_2013">
                <div id="roll2013">
                    <ul class="main_list">
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681JJ4400000F25.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681JJ4400000F25,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
