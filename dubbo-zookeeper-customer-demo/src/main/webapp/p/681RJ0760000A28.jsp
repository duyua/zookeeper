...
<head>
    ...
    <title>纯色长袖针织连衣裙 - Miss Sixty 中国官网</title>

    <meta name="description" content="纯色长袖针织连衣裙,681RJ0760000A28,欢迎访问MissSixty官方中文网站。源自意大利的女性牛仔品牌，始于1991，一直为性感时尚的女性带来极具个性与创造力的牛仔设计。点击访问，轻松享受便捷的购物体验及获取最新牛仔潮流资讯。" />
    <meta name="keywords" content="MISS SIXTY | 意大利女性时尚牛仔品牌,纯色长袖针织连衣裙,miss sixty官网,miss sixty,misssixty,miss sixty官方购物网,Miss Sixty中文官网,Miss Sixty中国,Miss Sixty亚洲,Miss Sixty购物,Miss Sixty正品,潮流牛仔,M60,丹宁,女性牛仔,品牌女装,服装商城,意大利女装,意大利牛仔" />
    ...
    <script>
        ...
        proInfo.imgUrl = 'http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ0760000A28/681RJ0760000A28_s_2.jpg';
                ...
                <div class="detail_center">
                    ...
                    <div class="pro_img">
                        <div id="productImgTab" class="pro_smallpic_box">
                            ...
                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ0760000A28,s,1" onclick="te$.ui.zoom.setSrc('681RJ0760000A28','1', 's')" alt="纯色长袖针织连衣裙"  class="active"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ0760000A28/681RJ0760000A28_s_1.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ0760000A28,s,2" onclick="te$.ui.zoom.setSrc('681RJ0760000A28','2', 's')" alt="纯色长袖针织连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ0760000A28/681RJ0760000A28_s_2.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ0760000A28,s,3" onclick="te$.ui.zoom.setSrc('681RJ0760000A28','3', 's')" alt="纯色长袖针织连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ0760000A28/681RJ0760000A28_s_3.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ0760000A28,s,4" onclick="te$.ui.zoom.setSrc('681RJ0760000A28','4', 's')" alt="纯色长袖针织连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ0760000A28/681RJ0760000A28_s_4.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ0760000A28,s,5" onclick="te$.ui.zoom.setSrc('681RJ0760000A28','5', 's')" alt="纯色长袖针织连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ0760000A28/681RJ0760000A28_s_5.jpg -->
                        </div>
                        ...
                        <div id="productImgShow" class="pro_bigpic_box">
                            <div id="jqzoom" class="product_img_show">
                                ...
                                <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ0760000A28,m,1" alt="纯色长袖针织连衣裙" jqimg="">
                            </div>
                            <script>
                                (function(){
                                    t$('jqzoom').getElementsByTagName('img')[0].setAttribute('jqimg', te$.skuToImgUrl('681RJ0760000A28', 'b', 1));
                                })();
                            </script>
                    ...
                    <div class="pro_info">
                        ...
                        <div id="proSellOut" class="pro_sell_out">
                            <!--正常-->
                            <a id="btnSellOut" target="_blank" href="/applets/ProductArrivalNoticeAdd.do?productItemId=681RJ0760000A28" class="btn_sell_out">到货通知</a>
                            <script>
                                (function(){
                                    var s = t$('btnSellOut');
                            ...
                            <dd class="detail_content_box active">
                                <div class="detail_content_txt" id="productInfo"><!-- id="detailContent1" -->
                                    ...
                                    <dl>
                                        <dt><span>-</span> 设计</dt>
                                        <dd>
                                            采用柔软混纺针织面料制成，穿着舒适透气自在；精致的花纹图案复古又柔美，配有吊带衬裙，可平衡镂空透视的裙身，确保穿着稳妥。不妨参考模特利用腰封美化身材曲线，提升个性时髦度。
                                        </dd>
                                    </dl>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            ● 宽松剪裁<br>● 中等重量面料，带弹力<br>● 模特身高 176 厘米，所穿尺码 s
                                        </dd>
                                        <script>
                                            (function(){
                                                var size = [["尺码","上身长/全长","肩宽","胸围","裤长/袖长","腰围","臀围","脚口围/摆围","适合身高","",""],["XS","87.0","36.0","75.0","46.0","-","-","94.0","154/159"],["S","89.0","37.0","79.0","47.0","-","-","96.0","160/165"],["M","91.0","39.0","81.0","48.0","-","-","98.0","166/171"]];
                                                if (size) {
