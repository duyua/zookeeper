...
<head>
    ...
    <title>百褶短袖雪纺连衣裙 - Miss Sixty 中国官网</title>

    <meta name="description" content="百褶短袖雪纺连衣裙,681DJ1920000G24,欢迎访问MissSixty官方中文网站。源自意大利的女性牛仔品牌，始于1991，一直为性感时尚的女性带来极具个性与创造力的牛仔设计。点击访问，轻松享受便捷的购物体验及获取最新牛仔潮流资讯。" />
    <meta name="keywords" content="MISS SIXTY | 意大利女性时尚牛仔品牌,百褶短袖雪纺连衣裙,miss sixty官网,miss sixty,misssixty,miss sixty官方购物网,Miss Sixty中文官网,Miss Sixty中国,Miss Sixty亚洲,Miss Sixty购物,Miss Sixty正品,潮流牛仔,M60,丹宁,女性牛仔,品牌女装,服装商城,意大利女装,意大利牛仔" />
    ...
    <script>
        var	proInfo = {
            storeId : '23',
            cId : '137471',
            ecsId : '#1258#1305#1448#1454#1909#5171#1239#1246#1242#',
            buyAble : 1, //1,
            sku : '681DJ1920000G24',
            proName : '百褶短袖雪纺连衣裙',
            brandInfo : 'misssixty',
        ...
        proInfo.imgUrl = 'http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ1920000G24/681DJ1920000G24_s_2.jpg';
                ...
                <div class="detail_center">
                    ...
                    <div class="pro_img">
                        <div id="productImgTab" class="pro_smallpic_box">
                            ...
                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ1920000G24,s,1" onclick="te$.ui.zoom.setSrc('681DJ1920000G24','1', 's')" alt="百褶短袖雪纺连衣裙"  class="active"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ1920000G24/681DJ1920000G24_s_1.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ1920000G24,s,2" onclick="te$.ui.zoom.setSrc('681DJ1920000G24','2', 's')" alt="百褶短袖雪纺连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ1920000G24/681DJ1920000G24_s_2.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ1920000G24,s,3" onclick="te$.ui.zoom.setSrc('681DJ1920000G24','3', 's')" alt="百褶短袖雪纺连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ1920000G24/681DJ1920000G24_s_3.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ1920000G24,s,4" onclick="te$.ui.zoom.setSrc('681DJ1920000G24','4', 's')" alt="百褶短袖雪纺连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ1920000G24/681DJ1920000G24_s_4.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ1920000G24,s,5" onclick="te$.ui.zoom.setSrc('681DJ1920000G24','5', 's')" alt="百褶短袖雪纺连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ1920000G24/681DJ1920000G24_s_5.jpg -->
                        </div>
                        ...
                        <div id="productImgShow" class="pro_bigpic_box">
                            <div id="jqzoom" class="product_img_show">
                                ...
                                <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ1920000G24,m,1" alt="百褶短袖雪纺连衣裙" jqimg="">
                            </div>
                            <script>
                                (function(){
                                    t$('jqzoom').getElementsByTagName('img')[0].setAttribute('jqimg', te$.skuToImgUrl('681DJ1920000G24', 'b', 1));
                                })();
                            </script>
                    ...
                    <div class="pro_info">
                        ...
                        <div id="proSellOut" class="pro_sell_out">
                            <!--正常-->
                            <a id="btnSellOut" target="_blank" href="/applets/ProductArrivalNoticeAdd.do?productItemId=681DJ1920000G24" class="btn_sell_out">到货通知</a>
                            <script>
                                (function(){
                                    var s = t$('btnSellOut');
                        ...
                        <dl id="proColor" class="pro_option pro_color" style="display:none;">
                            <!-- <dt>颜色:</dt> -->
                            <dd>
                                <a href="/p/681DJ1920000C27.jsp" target="_blank"><img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ1920000C27,s,5" title="大红"></a>
                            </dd>
                        </dl>
                            ...
                            <dd class="detail_content_box active">
                                <div class="detail_content_txt" id="productInfo"><!-- id="detailContent1" -->
                                    ...
                                    <dl>
                                        <dt><span>-</span> 设计</dt>
                                        <dd>
                                            选用轻薄飘逸的雪纺面料制成，宽松流畅廓形，融合高收腰剪裁，巧妙包容和修饰身形；纤细的绑带优雅交叉，勾勒出迷人的肩部和手臂线条；百褶裙摆动感柔美，行走间展现动人美态。
                                        </dd>
                                    </dl>
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ...
                                            ● 宽松剪裁<br>● 轻薄面料，带弹力<br>● 模特身高 176 厘米，所穿尺码 s
                                        </dd>
                                        <script>
                                            (function(){
                                                var size = [["尺码","上身长/全长","肩宽","胸围","裤长/袖长","腰围","臀围","脚口围/摆围","适合身高","",""],["XS","118.0","-","-","-","85.0","-","620.0","154/159"],["S","120.0","-","-","-","88.0","-","630.0","160/165"],["M","122.0","-","-","-","91.0","-","640.0","166/171"],["L","124.0","-","-","-","95.0","-","651.0","172/175"]];
                                                if (size) {
                                    ...
                                    <dl>
                                        ...
                                        <dd>30℃以下网袋机洗；不可漂白；悬挂晾干；不可熨烫；不可干洗；不可曝晒；反面洗涤；请勿浸泡；请与同类颜色衣物洗涤</dd>
                                    </dl>

                                    <dl>
                                        <dt><span>-</span> 保养护理</dt>
                                        <dd>本产品上的压褶部分为设计效果，经洗涤后褶位会自然松散，属于正常现象，经低温熨烫，可保持原形。</dd>
                                    </dl>
                                </div>
                            </dd>
                        </dl>
            ...
            <div class="roll_box_2013">
                <div id="roll2013">
                    <ul class="main_list">
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681WJ2460000G24.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681WJ2460000G24,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681WJ4110000G24.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681WJ4110000G24,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681WJ5770000F25.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681WJ5770000F25,n,5">
                                </a>
                            </div>
                        </li>
                    </ul>
