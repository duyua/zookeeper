...
<head>
    ...
    <title>荷叶边长袖针织连衣裙 - Miss Sixty 中国官网</title>

    <meta name="description" content="荷叶边长袖针织连衣裙,681RJ1400000C03,欢迎访问MissSixty官方中文网站。源自意大利的女性牛仔品牌，始于1991，一直为性感时尚的女性带来极具个性与创造力的牛仔设计。点击访问，轻松享受便捷的购物体验及获取最新牛仔潮流资讯。" />
    <meta name="keywords" content="MISS SIXTY | 意大利女性时尚牛仔品牌,荷叶边长袖针织连衣裙,miss sixty官网,miss sixty,misssixty,miss sixty官方购物网,Miss Sixty中文官网,Miss Sixty中国,Miss Sixty亚洲,Miss Sixty购物,Miss Sixty正品,潮流牛仔,M60,丹宁,女性牛仔,品牌女装,服装商城,意大利女装,意大利牛仔" />
    ...
    <script>
        ...
        proInfo.imgUrl = 'http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ1400000C03/681RJ1400000C03_s_2.jpg';
                ...
                <div class="detail_center">
                    ...
                    <div class="pro_img">
                        <div id="productImgTab" class="pro_smallpic_box">
                            ...
                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ1400000C03,s,1" onclick="te$.ui.zoom.setSrc('681RJ1400000C03','1', 's')" alt="荷叶边长袖针织连衣裙"  class="active"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ1400000C03/681RJ1400000C03_s_1.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ1400000C03,s,2" onclick="te$.ui.zoom.setSrc('681RJ1400000C03','2', 's')" alt="荷叶边长袖针织连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ1400000C03/681RJ1400000C03_s_2.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ1400000C03,s,3" onclick="te$.ui.zoom.setSrc('681RJ1400000C03','3', 's')" alt="荷叶边长袖针织连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ1400000C03/681RJ1400000C03_s_3.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ1400000C03,s,4" onclick="te$.ui.zoom.setSrc('681RJ1400000C03','4', 's')" alt="荷叶边长袖针织连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ1400000C03/681RJ1400000C03_s_4.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ1400000C03,s,5" onclick="te$.ui.zoom.setSrc('681RJ1400000C03','5', 's')" alt="荷叶边长袖针织连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681RJ1400000C03/681RJ1400000C03_s_5.jpg -->
                        </div>
                        ...
                        <div id="productImgShow" class="pro_bigpic_box">
                            <div id="jqzoom" class="product_img_show">
                                ...
                                <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ1400000C03,m,1" alt="荷叶边长袖针织连衣裙" jqimg="">
                            </div>
                            <script>
                                (function(){
                                    t$('jqzoom').getElementsByTagName('img')[0].setAttribute('jqimg', te$.skuToImgUrl('681RJ1400000C03', 'b', 1));
                                })();
                            </script>
                    ...
                    <div class="pro_info">
                        ...
                        <div id="proSellOut" class="pro_sell_out">
                            <!--正常-->
                            <a id="btnSellOut" target="_blank" href="/applets/ProductArrivalNoticeAdd.do?productItemId=681RJ1400000C03" class="btn_sell_out">到货通知</a>
                            <script>
                                (function(){
                                    var s = t$('btnSellOut');
                        ...
                        <dl id="proColor" class="pro_option pro_color" style="display:none;">
                            <!-- <dt>颜色:</dt> -->
                            <dd>
                                <a href="/p/681RJ1400000G24.jsp" target="_blank"><img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681RJ1400000G24,s,5" title="黑色"></a>
                            </dd>
                        </dl>
                            ...
                            <dd class="detail_content_box active">
                                <div class="detail_content_txt" id="productInfo"><!-- id="detailContent1" -->
                                    ...
                                    <dl>
                                        <dt><span>-</span> 设计</dt>
                                        <dd>
                                            流畅优雅的廓形，融合弹力混纺针织面料，轻松勾勒和修饰性感的身材曲线；拥有新颖个性的挖肩设计，并缀饰灵动的荷叶边，尤显浪漫迷人；小喇叭双袖，更添复古柔美气质韵味。
                                        </dd>
                                    </dl>
                                    ...
                                    <dl>
                                        ...
                                        <script>
                                            (function(){
                                                var size = [["尺码","上身长/全长","肩宽","胸围","裤长/袖长","腰围","臀围","脚口围/摆围","适合身高","",""],["XS","67.0","27.0","66.0","57.0","60.0","-","-","154/159"],["S","69.0","29.0","70.0","58.0","64.0","-","-","160/165"],["M","71.0","30.0","74.0","59.0","68.0","-","-","166/171"],["L","73.0","32.0","78.0","60.0","72.0","-","-","172/175"]];
                                                if (size) {
                                    ...
                                    <dl>
                                        ...
                                        <dd>30℃以下网袋缓和机洗，不可漂白，撑开平放干衣，低温熨烫，不可干洗，不可曝晒，反面洗涤，请勿浸泡，请与同类颜色衣物洗涤</dd>
                                    </dl>

                                    <dl>
                                        <dt><span>-</span> 保养护理</dt>
                                        <dd>本产品采用纱支组织疏松型面料，风格时尚而独特，在使用过程中，纱支因摩擦会有少量抽出，此为正常现象；请注意避开尖利物品的勾刺、挂扯，使用网袋包裹洗涤，以防止纱支破损。</dd>
                                    </dl>
                                </div>
                            </dd>
                        </dl>
