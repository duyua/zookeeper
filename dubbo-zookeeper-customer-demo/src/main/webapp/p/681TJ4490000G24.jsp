...
<head>
    ...
    <title>纯色露肩长袖套头卫衣 - Miss Sixty 中国官网</title>

    <meta name="description" content="纯色露肩长袖套头卫衣,681TJ4490000G24,欢迎访问MissSixty官方中文网站。源自意大利的女性牛仔品牌，始于1991，一直为性感时尚的女性带来极具个性与创造力的牛仔设计。点击访问，轻松享受便捷的购物体验及获取最新牛仔潮流资讯。" />
    <meta name="keywords" content="MISS SIXTY | 意大利女性时尚牛仔品牌,纯色露肩长袖套头卫衣,miss sixty官网,miss sixty,misssixty,miss sixty官方购物网,Miss Sixty中文官网,Miss Sixty中国,Miss Sixty亚洲,Miss Sixty购物,Miss Sixty正品,潮流牛仔,M60,丹宁,女性牛仔,品牌女装,服装商城,意大利女装,意大利牛仔" />
    ...
    <script>
        ...
        proInfo.imgUrl = 'http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4490000G24/681TJ4490000G24_s_2.jpg';
                ...
                <div class="detail_center">
                    ...
                    <div class="pro_img">
                        <div id="productImgTab" class="pro_smallpic_box">
                            ...
                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4490000G24,s,1" onclick="te$.ui.zoom.setSrc('681TJ4490000G24','1', 's')" alt="纯色露肩长袖套头卫衣"  class="active"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4490000G24/681TJ4490000G24_s_1.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4490000G24,s,2" onclick="te$.ui.zoom.setSrc('681TJ4490000G24','2', 's')" alt="纯色露肩长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4490000G24/681TJ4490000G24_s_2.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4490000G24,s,3" onclick="te$.ui.zoom.setSrc('681TJ4490000G24','3', 's')" alt="纯色露肩长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4490000G24/681TJ4490000G24_s_3.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4490000G24,s,4" onclick="te$.ui.zoom.setSrc('681TJ4490000G24','4', 's')" alt="纯色露肩长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4490000G24/681TJ4490000G24_s_4.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4490000G24,s,5" onclick="te$.ui.zoom.setSrc('681TJ4490000G24','5', 's')" alt="纯色露肩长袖套头卫衣"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681TJ4490000G24/681TJ4490000G24_s_5.jpg -->
                        </div>
                        ...
                        <div id="productImgShow" class="pro_bigpic_box">
                            <div id="jqzoom" class="product_img_show">
                                ...
                                <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4490000G24,m,1" alt="纯色露肩长袖套头卫衣" jqimg="">
                            </div>
                            <script>
                                (function(){
                                    t$('jqzoom').getElementsByTagName('img')[0].setAttribute('jqimg', te$.skuToImgUrl('681TJ4490000G24', 'b', 1));
                                })();
                            </script>
                    ...
                    <div class="pro_info">
                        ...
                        <div id="proSellOut" class="pro_sell_out">
                            <!--正常-->
                            <a id="btnSellOut" target="_blank" href="/applets/ProductArrivalNoticeAdd.do?productItemId=681TJ4490000G24" class="btn_sell_out">到货通知</a>
                            <script>
                                (function(){
                                    var s = t$('btnSellOut');
                        ...
                        <dl id="proColor" class="pro_option pro_color" style="display:none;">
                            <!-- <dt>颜色:</dt> -->
                            <dd>
                                <a href="/p/681TJ4490000D12.jsp" target="_blank"><img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681TJ4490000D12,s,5" title="粉紫"></a>
                            </dd>
                        </dl>
                            ...
                            <dd class="detail_content_box active">
                                <div class="detail_content_txt" id="productInfo"><!-- id="detailContent1" -->
                                    ...
                                    <dl>
                                        <dt><span>-</span> 设计</dt>
                                        <dd>
                                            选用柔软透气纯棉面料制成，融合宽松流畅廓形，舒适包容和修饰身形；潮流露肩设计，展现迷人肩部肌肤和线条，性感又迷人，点缀以层次荷叶边，带来甜美俏皮气息，活力减龄。
                                        </dd>
                                    </dl>
                                    ...
                                    <dl>
                                        ...
                                        <script>
                                            (function(){
                                                var size = [["尺码","衣长","肩宽","胸围","袖长","腰围","适合身高"],["XS","50.0","37.0","87.0","46.0","87.0","154/159"],["S","51.0","38.0","90.0","47.0","90.0","160/165"],["M","52.0","39.0","93.0","48.0","93.0","166/171"],["L","53.0","40.0","97.0","48.0","97.0","172/175"]];
                                                if (size) {
            ...
            <div class="roll_box_2013">
                <div id="roll2013">
                    <ul class="main_list">
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681KJ4730000G24.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681KJ4730000G24,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681QJ8510000G24.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681QJ8510000G24,n,5">
                                </a>
                            </div>
                        </li>
                    </ul>
