...
<head>
    ...
    <title>纯棉荷叶边长袖连衣裙 - Miss Sixty 中国官网</title>

    <meta name="description" content="纯棉荷叶边长袖连衣裙,681DJ2780000A03,欢迎访问MissSixty官方中文网站。源自意大利的女性牛仔品牌，始于1991，一直为性感时尚的女性带来极具个性与创造力的牛仔设计。点击访问，轻松享受便捷的购物体验及获取最新牛仔潮流资讯。" />
    <meta name="keywords" content="MISS SIXTY | 意大利女性时尚牛仔品牌,纯棉荷叶边长袖连衣裙,miss sixty官网,miss sixty,misssixty,miss sixty官方购物网,Miss Sixty中文官网,Miss Sixty中国,Miss Sixty亚洲,Miss Sixty购物,Miss Sixty正品,潮流牛仔,M60,丹宁,女性牛仔,品牌女装,服装商城,意大利女装,意大利牛仔" />
    ...
    <script>
        var	proInfo = {
            storeId : '23',
            cId : '137487',
            ecsId : '#1258#1271#1305#1449#1909#5171#1239#1246#1242#',
            buyAble : 1, //1,
            sku : '681DJ2780000A03',
            proName : '纯棉荷叶边长袖连衣裙',
            brandInfo : 'misssixty',
        ...
        proInfo.imgUrl = 'http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ2780000A03/681DJ2780000A03_s_2.jpg';
                ...
                <div class="detail_center">
                    ...
                    <div class="pro_img">
                        <div id="productImgTab" class="pro_smallpic_box">
                            ...
                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ2780000A03,s,1" onclick="te$.ui.zoom.setSrc('681DJ2780000A03','1', 's')" alt="纯棉荷叶边长袖连衣裙"  class="active"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ2780000A03/681DJ2780000A03_s_1.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ2780000A03,s,2" onclick="te$.ui.zoom.setSrc('681DJ2780000A03','2', 's')" alt="纯棉荷叶边长袖连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ2780000A03/681DJ2780000A03_s_2.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ2780000A03,s,3" onclick="te$.ui.zoom.setSrc('681DJ2780000A03','3', 's')" alt="纯棉荷叶边长袖连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ2780000A03/681DJ2780000A03_s_3.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ2780000A03,s,4" onclick="te$.ui.zoom.setSrc('681DJ2780000A03','4', 's')" alt="纯棉荷叶边长袖连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ2780000A03/681DJ2780000A03_s_4.jpg -->

                            <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ2780000A03,s,5" onclick="te$.ui.zoom.setSrc('681DJ2780000A03','5', 's')" alt="纯棉荷叶边长袖连衣裙"  /><!-- http://img1.ochirly.com.cn/wcsstore/TrendyCatalogAssetStore/images/trendy/misssixty/2018/a/681DJ2780000A03/681DJ2780000A03_s_5.jpg -->
                        </div>
                        ...
                        <div id="productImgShow" class="pro_bigpic_box">
                            <div id="jqzoom" class="product_img_show">
                                ...
                                <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif" data-sku="681DJ2780000A03,m,1" alt="纯棉荷叶边长袖连衣裙" jqimg="">
                            </div>
                            <script>
                                (function(){
                                    t$('jqzoom').getElementsByTagName('img')[0].setAttribute('jqimg', te$.skuToImgUrl('681DJ2780000A03', 'b', 1));
                                })();
                            </script>
                    ...
                    <div class="pro_info">
                        ...
                        <div id="proSellOut" class="pro_sell_out">
                            <!--正常-->
                            <a id="btnSellOut" target="_blank" href="/applets/ProductArrivalNoticeAdd.do?productItemId=681DJ2780000A03" class="btn_sell_out">到货通知</a>
                            <script>
                                (function(){
                                    var s = t$('btnSellOut');
                            ...
                            <dd class="detail_content_box active">
                                <div class="detail_content_txt" id="productInfo"><!-- id="detailContent1" -->
                                    ...
                                    <dl>
                                        <dt><span>-</span> 设计</dt>
                                        <dd>
                                            选用柔软透气的纯棉面料制成，时尚大V领设计展现迷人的颈部肌肤线条，同时视觉修饰脸型；前幅加入夸张的荷叶边装饰，带来灵动之感和优雅气质；附送棉质腰封，可搭配穿着束紧宽松廓形，凸显玲珑细腰，美化身材曲线。
                                        </dd>
                                    </dl>
                                    ...
                                    <dl>
                                        ...
                                        <script>
                                            (function(){
                                                var size = [["尺码","上身长/全长","肩宽","胸围","裤长/袖长","腰围","臀围","脚口围/摆围","适合身高","",""],["XS","82.0","-","89.0","64.0","94.0","-","133.0","154/159"],["S","83.0","-","92.0","65.0","97.0","-","136.0","160/165"],["M","85.0","-","95.0","66.0","100.0","-","139.0","166/171"],["L","86.0","-","99.0","66.0","104.0","-","143.0","172/175"]];
                                                if (size) {
                                    ...
                                    <dl>
                                        ...
                                        <dd>
                                            ● 面料:棉100%<br>● 腰封面料：棉100% 腰封里料:聚酯纤维57% 粘纤43%
                                        </dd>
                                    </dl>
            ...
            <div class="roll_box_2013">
                <div id="roll2013">
                    <ul class="main_list">
                        ...
                        <li>
                            <div class="chip">
                                <a target="_blank" href="/p/681WJ4150000F25.jsp">
                                    <img src="http://img2.misssixty.com.cn/rs/common/v1/web/css/blank.gif"  data-sku="681WJ4150000F25,n,5">
                                </a>
                            </div>
                        </li>
                        <li>
